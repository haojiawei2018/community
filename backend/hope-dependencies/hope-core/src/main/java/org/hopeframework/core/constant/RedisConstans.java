...
public class RedisConstans {
	...
	/** 用户信息缓存 */
	public static final String CACHE_NAME_USRE_INFO = "USER_INFO";

	/** 用户Access信息缓存 */
	public static final String CACHE_NAME_ACCESS = "ACCESS";

	/** 用户登录错误信息缓存 */
	public static final String CACHE_NAME_LOGIN_ERROR = "LOGIN_ERROR";
