...
> **使用声明**
>
> 本项目仅用于个人学习、技术交流和教学演示。未经作者授权，不得用于商业用途；如需商业使用或商业授权，请联系作者，微信：`hhhhhhjw2023`。

## 在线访问

- 商户管理后台：[http://42.193.104.179/admin](http://42.193.104.179/admin)
- H5 用户端：[http://42.193.104.179/h5](http://42.193.104.179/h5)
